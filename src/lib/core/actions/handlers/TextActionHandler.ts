...
export class TextActionHandler implements ActionHandler {
    ...
    async copy(element: HTMLElement): Promise<void> {
        ...
        try {
            ...
            console.log('[TextActionHandler] Text copied successfully:', textContent.substring(0, 50) + '...');
        } catch (error) {
    ...
    async paste(element: HTMLElement): Promise<void> {
        ...
        try {
            ...
            console.log('[TextActionHandler] Text pasted successfully:', textToPaste.substring(0, 50) + '...');
        } catch (error) {
