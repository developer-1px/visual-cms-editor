...
export interface SelectionItem {
  ...
  data?: unknown // Additional data like template info for sections
}
...
export class SelectionManager {
  ...
  public isSelected(element: HTMLElement | number, type?: SelectionType, context?: SelectionContext): boolean {
  ...
  // Private methods
  private generateId(element: HTMLElement | number, type: SelectionType, context: SelectionContext): string {
